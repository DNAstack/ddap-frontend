...
//
///**
// * 1. Create 2 beacon resources by doing post/put to DAM via a DDAP endpoint (DDAP bff).
// * 2. Query the above created resource using the aggregate search endpoint
// * 3. Delete the resource in #1. DELETE to DDAP BFF: GET/POST/PUT/PATCH/DELETE /dam/v1/config/resources/resourceName
// */
//public class AggregateSearchE2eTest {
//
//    //@Getter
...
//
//    @Test
//    public void aggregateSearchTest() throws IOException {
//
